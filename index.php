    ...
    <?php
        ...
        <script>
            ...
            function drawCanvas() {
                ...
                ctx.fillStyle = \'#e0e0e0\'; // Light grey background for the photo area
                ...
                if (currentImage) {
                    ...
                    if (imageAspectRatio > previewAspectRatio) {
                        // Image is wider than preview area, constrain by width
                        imgDrawHeight = previewWidth / imageAspectRatio;
                        imgDrawY = offsetY + (previewHeight - imgDrawHeight) / 2; // Center vertically
                    } else {
                        // Image is taller than preview area, constrain by height
                        imgDrawWidth = previewHeight * imageAspectRatio;
                        imgDrawX = offsetX + (previewWidth - imgDrawWidth) / 2; // Center horizontally
                    }
            ...
            sampleFrameBtns.forEach(button => {
                button.addEventListener(\'click\', () => {
                    ...
                    if (frameUrl) {
                        ...
                        currentFramePattern = null; // No frame selected
                        drawCanvas();
                    }
                });
            });
            ...
            function resizeCanvas() {
                ...
                if (canvas.width !== displayWidth || canvas.height !== displayHeight) {
                    ...
                    drawCanvas(); // Redraw content after resize
                }
            }
            ...
            //             drawCanvas(); // Initial draw with default content
            //         });
            //     });
            // });
